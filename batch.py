...
channels = sorted(["@Lunduke", "@NaomiBrockwell", "@TheLinuxGamer",
                   ...
                   "@TechFox", "@GaminGHD", "@nickatnyte", "@FreeTalkLive",
                   "@BlueDrake42", "@seadox", "@icecreamcat", "@TheSchiffReport",
                   "@CrazyFoxMovies", "@Barnacules", "@copchronicles",
                   "@MinutePhysics", "@GamesGlitches", "@LBRYEsp",
                   ...
                   "@TipWhatYouLike", "@MusicPlanet", "@coolosertech",
                   "@cleverly", "@EliTheComputerGuy", "@MrRiosoMusic",
                   "@3Blue1Brown", "@altcoinbuzz", "@BrendonBrewer",
                   "@anton#1c10545675c9d25749fc12f6e872777da257dd51",
                   "@LBRY-Social", "@capitalresearch",
                   "@zO-Music", "@KhanAcademy", "@Michaelcraigheadart",
                   "@postjazzrdg", "@LemonAiden3340", "@Itsrucka",
                   "@nuggetsnews", "@MrRiosoMusic", "@MH",
                   "@DanielSibisan", "@jeradhill", "@JuliaGalef",
                   "@NorVegan", "@VeganGains", "@UCBerkeley", "@retrorgb",
                   "@KJamesElliott", "@reefermadness",
                   "@kidsgamesfun#09cf3bee6168dcc2103634f0d7f235747ce876b7",
                   "@veritasium", "@radiodrama", "@inspirationart",
                   "@Archaeosoup", "@eevblog", "@FEEOrg", "@3dprinting",
